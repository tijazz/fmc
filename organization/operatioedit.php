    ...
    <body>
        ...
        <div class="modal-body">
            ...
            if (isset($_POST['edit'])) {
                ...
                $sql = "UPDATE `operation` SET `category`=(:category), `name`=(:name), `description`=(:description), `quantity`=(:quantity), `manufacturer`=(:manufacturer), `status`=(:status), `location`=(:location), `place`=(:place) WHERE sn=(:sn)";
                ...
                $sql = "SELECT * from `operation` WHERE sn=(:idedit)";
                $query = $dbh->prepare($sql);
            ...
            ?>
                <form action="operatioedit.php" method="POST" class="forma">
