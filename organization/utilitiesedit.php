    ...
    <body>
        ...
        <div class="modal-body">
            ...
            if (isset($_POST['edit'])) {
                ...
                $sql = "UPDATE `utilities` SET `name`=(:name), `description`=(:description),  `amount`=(:amount) WHERE id=(:sn)";
                ...
                $sql = "SELECT * from `utilities` WHERE id=(:idedit)";
                $query = $dbh->prepare($sql);
            ...
            ?>
                <form action="utilitiesedit.php" method="POST" class="forma">
