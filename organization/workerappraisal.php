            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="navbar">
                        <div class="container-fluid" style="padding-left:7px;">
                            <h1 class="nav navbar-nav">
                                <a class="btn btn-md btn-primary" href="#add" data-target="#add" data-toggle="modal" style="color:#fff;" class="small-box-footer"><i class="glyphicon glyphicon-plus text-blue"></i> Add worker Appraisal</a>
                            </h1>
                        </div>
                    </div>
                    <!-- button style End -->
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">workers Appraisal list</div>
                        <div class="panel-body">
                            ...
                            <table id="zctb tablePreview" class="display table table-dark table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    ...
                                    $query->bindValue(":data_type", "worker", PDO::PARAM_STR);
                                    $query->execute();
                                    ...
                                    if ($query->rowCount() > 0) {
                                        foreach ($results as $result) {                ?>
                                            <tr>
                                                ...
                                                <?php
                                                $sq = "SELECT * FROM `worker` WHERE id = :id";
                                                $qu = $dbh->prepare($sq);
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content" style="height:auto">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">Appraise worker</h4>
                                    </div>

                                    <div class="modal-body">
                                        <form action="workerappraisal.php" method="POST" class="forma" enctype="multipart/form-data" onSubmit="return validate()">
