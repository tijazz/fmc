<?php
        ...
        header('location:index.php');
			...
			$sql ="INSERT INTO employee(image, name, email, gender, role, phone) VALUES(:image, :name, :email, :gender, :role, :phone)";
			$query= $dbh -> prepare($sql);
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<tbody>
										...
										<tr>
											...
											<td>
											<a href="editemployee.php?edit=<?php echo $result->id;?>" onclick="return confirm('Do you want to Edit');">&nbsp; <i class="fa fa-pencil"></i></a>&nbsp;&nbsp;
