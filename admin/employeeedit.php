...
if (isset($_POST['edit'])) {
    ...
    $sql = "UPDATE employee SET user_id=(:user_id), image=(:image), name=(:name), email=(:email), password=(:password), gender=(:gender), role=(:role),  phone=(:phone), contract_start=(:contract_start), contract_end=(:contract_end) WHERE id=(:idedit)";
