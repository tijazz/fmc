<?php
        ...
        header('location:index.php');
                ...
                $sql="UPDATE employee SET qualityofwork=(:qualityofwork), teamwork=(:teamwork), punctuality=(:punctuality) WHERE id=(:idedit)";
    ...
    <div id="wrapper">
        ...
        ?>
            ...
            <div id="page-wrapper" class="gray-bg dashbard-1">
                ...
                <div class="panel-heading">	<h2 class="page-title">Edit Employee : <?php echo htmlentities($result->name); ?></h2></div>
				</div>
            <div class="row">
