...
<body>
    ...
    <div id="wrapper">
        ...
        ?>
            ...
            <div id="page-wrapper" class="gray-bg dashbard-1">
                ...
                <div class="panel-heading" style='padding:0;'><h2 class="page-title">Power List</h2></div>
				</div>
            <div class="row">
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="height:auto">
              ...
              <form action="powerform.php" method="POST" class="forma">
                    <p>
