            ...
            if(isset($_GET['del']) && isset($_GET['email']))
                {
                    ...
                    $sql = "delete from workerappraisal WHERE id=:id";
                    $query = $dbh->prepare($sql);
                    $query -> bindParam(':id',$id, PDO::PARAM_STR);
                    $query -> execute();

                    $msg="Worker Appraisal Deleted successfully";
                }              
		}    
?>
    ...
    <div id="wrapper">
        ...
        ?>
            ...
            <div class="row">
                ...
                <div class="panel-heading">List Worker Appraisal</div>
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<tbody>
										...
										<tr>
											...
											<td>
											<a href="editworkappraisal.php?edit=<?php echo $result->id;?>" onclick="return confirm('Do you want to Edit');">&nbsp; <i class="fa fa-pencil"></i></a>&nbsp;&nbsp;
											<!-- <a href="worker.php?del=<?php echo $result->id;?>&email=<?php echo htmlentities($result->email);?>" onclick="return confirm('Do you want to Delete');"><i class="fa fa-trash" style="color:red"></i></a>&nbsp;&nbsp;
											--></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
                ...
                <h4 class="modal-title">Update Worker Appraisal</h4>
              </div>
              <div class="modal-body">
              <form action="workerappraisal.php?edit" method="POST" class="forma" enctype="multipart/form-data">
