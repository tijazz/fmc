...
if (isset($_POST['submit'])) {
    ...
    if (move_uploaded_file($file_loc, $folder . $final_file)) {
        ...
        $sql = "INSERT INTO worker (`user_id`, `image`, `name`, `email`, `password`, `gender`, `role`, `phone`, `contract_start`, `contract_end`) VALUES(:user_id, :image, :name, :email, :password, :gender, :role, :phone, :contract_start, :contract_end);";
        $query = $dbh->prepare($sql);
