                                            ...
                                            foreach ($results as $result) {      ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content" style="height:auto">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form action="fieldweeklyreport.php" method="POST" class="forma">
                                                                            <p>
                                                                                <label for="week">Week</label>
                                                                                <input type="week" name="week" value="<?php echo $result->week ?>">
                                                                            </p>
                                                                            ...
                                                                            <p>
                                                                                ...
                                                                                <select name="name" id="">
                                                                                    ...
                                                                                    if ($q->rowCount() > 0) {
                                                                                        foreach ($res as $re) {                ?>
                                                                                            <option value="<?php echo htmlentities($re->id); ?>" <?= $re->id == $result->name ? 'SELECTED' : '' ?>>
                                                                            ...
                                                                            <p>
                                                                                ...
                                                                                <select name="activity_status" id="">
                                                                                    <option value="Completed" <?= $result->name == "Completed" ? 'SELECTED' : '' ?>>Completed</option>
                                                                                    <option value="On Going" <?= $result->name == "On Going" ? 'SELECTED' : '' ?>>On Going</option>
                                                                                </select>
                                                                            </p>
                                                        ...
                                                        <a href="fieldweeklyreport.php?del=<?php echo $result->id; ?>" onclick="return confirm('Do you want to Delete');"><i class="fa fa-trash" style="color:red"></i></a>&nbsp;&nbsp;
