                            ...
                            <div class="panel-body">
                                ...
                                <table id="zctb tablePreview" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $sql = "SELECT * from weeklyreport WHERE user_id = (:user_id) AND type = 'facility'";
                                        $query = $dbh->prepare($sql);
                                        ...
                                        if ($query->rowCount() > 0) {
                                            foreach ($results as $result) {                ?>
                                                <tr>
                                                    ...
                                                    <td><?php
                                                        $s = "SELECT * FROM `building` WHERE id = (:id) AND org_id = (:org_id)";
                                                        $q = $dbh->prepare($s);
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content" style="height:auto">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form action="facilityweeklyreport.php" method="POST" class="forma">
                                                                            <p>
                                        ...
                                        <div class="modal-body">
                                            <form action="facilityweeklyreport.php" method="POST" class="forma">
                                                ...
                                                <p>
                                                    ...
                                                    <select name="name" id="">
                                                        <?php
                                                        $sql = "SELECT * FROM `building` WHERE user_id = (:user_id)";
                                                        $query = $dbh->prepare($sql);
                                                        $query->bindParam(':user_id', $_SESSION['user_id'], PDO::PARAM_STR);
                                                        $query->execute();
                                                        $results = $query->fetchAll(PDO::FETCH_OBJ);
