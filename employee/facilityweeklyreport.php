                            ...
                            <div class="panel-body">
                                ...
                                <table id="zctb tablePreview" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $sql = "SELECT * from weeklyreport WHERE org_id = (:org_id) AND type = 'facility' AND user_id=(:user_id)";
                                        $query = $dbh->prepare($sql);
                                        ...
                                        <div class="modal-body">
                                            <form action="facilityweeklyreportform.php" method="POST" class="forma">
                                                ...
                                                <p>
                                                    ...
                                                    <select name="name" id="">
                                                        <?php
                                                        $sql = "SELECT * FROM `building` WHERE org_id = (:org_id) AND user_id = :user_id";
                                                        $query = $dbh->prepare($sql);
                                                        $query->bindParam(':org_id', $_SESSION['org_id'], PDO::PARAM_STR);
                                                        $query->bindParam(':user_id', $_SESSION['id'], PDO::PARAM_STR);
                                                        $query->execute();
