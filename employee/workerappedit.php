...
?>
    ...
    <?php
            if (isset($_POST['submit'])) {
                ...
                $sql = "UPDATE worker SET quality_of_work=(:qualityofwork), team_work=(:teamwork), punctuality=(:punctuality) WHERE id=(:idedit)";
        ...
        <div class="modal-body">
                ...
                <form action="workerappedit.php" method="post" class="form-horizontal" enctype="multipart/form-data">
