                            ...
                            <div class="panel-body">
                                ...
                                <table id="zctb tablePreview" class="display table table-dark table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $sql = "SELECT * from `locations` WHERE org_id=:org_id AND user = :user_id";
                                        $query = $dbh->prepare($sql);
                                        ...
                                        if ($query->rowCount() > 0) {
                                            foreach ($results as $result) {                ?>
                                                <tr>
                                                    ...
                                                    <!-- Action Button Start -->
                                                    <td>
                                                        <a data-toggle="modal" href="landedit.php?s=<?php echo $result->id; ?>" data-target="#MyModal" data-backdrop="static">&nbsp;
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content" style="height:auto">
                                        ...
                                        <div class="modal-body">
                                            <form action="landform.php" method="POST" class="forma" id="f_edit">
