...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = "UPDATE `vehicle` SET `state`=(:state) WHERE id=(:id)";
        $query = $dbh->prepare($sql);
                            ...
                            <div class="panel-body">
                                ...
                                <table id="zctb tablePreview" class="display table table-dark table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $sql = "SELECT * from `vehicle` WHERE user_id=:user_id";
                                        $query = $dbh->prepare($sql);
                                    ...
                                    <div class="modal-content" style="height:auto">
                                        ...
                                        <div class="modal-body">
                                            <form action="vehiclelist.php" method="POST" class="forma">
                                                ...
                                                <p>
                                                    <label for="size">Vehicle Serial Number</label>
                                                    <input type="text" name="serial_no" value="">
                                                </p>

                                                <p>
                                                    <label for="location">Manufacturer</label>
