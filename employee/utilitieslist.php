    ...
    <div id="wrapper">
        ...
        ?>
            ...
            <div id="page-wrapper" class="gray-bg dashbard-1">
                ...
                <div class="panel-heading" style='padding:0;'><h2 class="page-title">Manage Utilities</h2></div>
				</div>
            <div class="row">
                       
                <div class="col-lg-12">

                    <h1><a class="btn btn-lg btn-md btn-primary" href="#add" data-target="#add" data-toggle="modal" style="color:#fff;" class="small-box-footer"><i class="glyphicon glyphicon-plus text-blue"></i></a></h1>
