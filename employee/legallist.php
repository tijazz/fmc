...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_GET['del'])) {
        ...
        $sql = "delete from legal WHERE id=:id";
    ...
    if (isset($_POST['edit'])) {
        ...
        $sql = "UPDATE `legal` SET `name`=(:name), `description`=(:description), `ppunit`=(:ppunit), `qitem`=(:qitem), `amount`=(:amount) WHERE id=(:id)";
        $query = $dbh->prepare($sql);
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">legal list</div>
                            <div class="panel-body">
                                ...
                                <table id="zctb tablePreview" class="display table table-dark table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $sql = "SELECT * from legal WHERE user_id = :user_id";
                                        $query = $dbh->prepare($sql);
                                            ...
                                            foreach ($results as $result) {                ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content" style="height:auto">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form action="legallist.php" method="POST" class="forma">
                                                        ...
                                                        <a href="legallist.php?del=<?php echo $result->id; ?>" onclick="return confirm('Do you want to Delete');"><i class="fa fa-trash" style="color:red"></i></a>&nbsp;&nbsp;
                                                    </td>
                            ...
                            <div id="add" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                <div class="modal-dialog">
                                    <div class="modal-content" style="height:auto">
                                        ...
                                        <div class="modal-body">
                                            <form action="legal.php" method="POST" class="forma">
