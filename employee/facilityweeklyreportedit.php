...
?>
    ...
    <body>
        ...
        <div class="modal-body">
            ...
            ?>
                <form action="facilityweeklyreportedit.php" method="POST" class="forma">
                    <p>
                    ...
                    <p>
                        ...
                        <select name="name" id="">
                            <?php
                            $s = "SELECT * FROM `building` WHERE org_id = (:org_id) AND user_id = :user_id";
                            $q = $dbh->prepare($s);
                            $q->bindParam(':org_id', $_SESSION['org_id'], PDO::PARAM_STR);
                            $q->bindParam(':user_id', $_SESSION['id'], PDO::PARAM_STR);
                            $q->execute();
